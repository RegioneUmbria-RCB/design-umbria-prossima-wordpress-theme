            ...
            <div class="container" id="main-container">
                ...
                <div class="row">
                    <div class="col-lg-8 px-lg-4 py-lg-2">
                        ...
                        <?php if($tipo_documento && $tipo_documento[0]):?>
                            <div class="d-flex gap-2 align-items-center flex-wrap mb-3">
                                <strong>Tipo di documento:</strong>
                                <div class="chip chip-simple border-success bg-white text-truncate m-0">
                                    <span class="chip-label text-color-success"><?php echo $tipo_documento[0]->name; ?></span>
                                </div>
                            </div>
                        <?php endif; ?>
                        <?php $terms = get_the_terms(get_the_ID(), 'focus');
                            ...
                            <div class="d-flex gap-2 align-items-center flex-wrap mb-3">
                                ...
                                <?php foreach ($terms as $term) : 
                                    ...
                                    if (!is_wp_error($term_link)) : ?>
                                        ...
                                        class="chip chip-simple border-success bg-white text-truncate m-0">
                                            <span class="chip-label text-color-success">
                                                <?= esc_html($term->name); ?>
                                            </span>
                                        </a>
                                    <?php endif; ?>
                            ...
                            <section id="autore" class="it-page-section mb-5">
                                ...
                                <div class="card-wrapper card-teaser-wrapper card-teaser-wrapper-equal">
                                    <?php foreach ($autori as $persona_id) { ?>
                                        <div class="card card-teaser shadow-sm p-4 mt-3 rounded border border-light flex-nowrap">
                                            <?php get_template_part("template-parts/loop/card-persona-pubblica-1", false, get_post($persona_id)); ?>
                                        </div>
                                    <?php } ?>
                                </div>
                            </section>
                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-6">
                                        <?php foreach ($servizi as $servizio_id) {
                                            ...
                                            $with_border = true;
                                            get_template_part("template-parts/loop/card-servizio-1", false,  $servizio);
                                        } ?>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section id="documenti_collegati" class="it-page-section mb-5">
                                ...
                                <div class="row">
                                    ...
                                    <?php foreach ($documenti_collegati as $documento_id) {
                                        $documento = get_post($documento_id);
                                        $with_border = true;
                                        get_template_part("template-parts/loop/card-documento-pubblico-1", false, $documento);
                                    } ?>
                                    </div>
                                </div>
                            </section>
