...
function asset_path_faiconselect() { // Fix for $asset_path issue for Icon field
    return get_template_directory_uri(). '/inc/origin-tema-comuni/lib/cmb2-field-type-font-awesome'; //Change to correct path.
}
...
add_filter( 'pw_cmb2_field_select2_asset_path', function ($var){return get_template_directory_uri().'/inc/origin-tema-comuni/lib/cmb-field-select2-master';});
