...
if ( $args ) : 
  ...
  $permalink = !empty($external_link)? $external_link : get_post_meta( $post_id, '_dci_sito_tematico_link', true );
  $excerpt   = get_post_meta( $post_id, '_dci_sito_tematico_descrizione_breve', true );
  $image_id  = get_post_meta( $post_id, '_dci_sito_tematico_immagine_id', true );
?>
