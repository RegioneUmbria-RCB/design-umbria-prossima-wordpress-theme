					...
					<aside class="col-lg-4">
						...
						<div class="card-wrapper card-teaser-wrapper card-teaser-wrapper-equal">
							...
							<div class="card card-teaser shadow-sm p-4 mt-3 rounded border border-light flex-nowrap">
								...
								<div class="card-body">
								<h5 class="card-title">
									<a class="text-decoration-none text-primary" href="<?php echo get_the_guid($dichiarazione); ?>" aria-label="Scarica l'allegato <?php echo $dichiarazione->post_title; ?>" title="Scarica l'allegato <?php echo $dichiarazione->post_title; ?>">
						...
						<div class="card-wrapper card-teaser-wrapper card-teaser-wrapper-equal">
							...
							<div class="card card-teaser shadow-sm p-4 mt-3 rounded border border-light flex-nowrap">
								...
								<div class="card-body">
								<h5 class="card-title">
									<a class="text-decoration-none text-primary" href="<?php echo get_the_guid($spesa_elettorale); ?>" aria-label="Scarica l'allegato <?php echo $spesa_elettorale->post_title; ?>" title="Scarica l'allegato <?php echo $spesa_elettorale->post_title; ?>">
						...
						<div class="card-wrapper card-teaser-wrapper card-teaser-wrapper-equal">
							...
							<div class="card card-teaser shadow-sm p-4 mt-3 rounded border border-light flex-nowrap">
								...
								<div class="card-body">
								<h5 class="card-title">
									<a class="text-decoration-none text-primary" href="<?php echo get_the_guid($variazione_sp); ?>" aria-label="Scarica l'allegato <?php echo $variazione_sp->post_title; ?>" title="Scarica l'allegato <?php echo $variazione_sp->post_title; ?>">
						...
						<div class="card-wrapper card-teaser-wrapper card-teaser-wrapper-equal">
							...
							<div class="card card-teaser shadow-sm p-4 mt-3 rounded border border-light flex-nowrap">
								...
								<div class="card-body">
								<h5 class="card-title">
									<a class="text-decoration-none text-primary" href="<?php echo get_the_guid($altra_carica); ?>" aria-label="Scarica l'allegato <?php echo $altra_carica->post_title; ?>" title="Scarica l'allegato <?php echo $altra_carica->post_title; ?>">
